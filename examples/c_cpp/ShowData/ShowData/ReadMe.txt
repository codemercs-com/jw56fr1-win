================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: ShowData-Projektübersicht
===============================================================================

Diese ShowData-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt. Diese Anwendung zeigt nicht nur die Grundlagen der Verwendung von Microsoft Foundation Classes, sondern dient auch als Ausgangspunkt für das Schreiben Ihrer Anwendung.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre ShowData-Anwendung besteht.
...
ShowData.h
    ...
    Sie enthält andere projektspezifische Header (einschließlich Resource.h) und deklariert die CShowDataApp-Anwendungsklasse.

ShowData.cpp
    Dies ist die wichtigste Anwendungsquelldatei, die die Anwendungsklasse CShowDataApp enthält.
...
res\ShowData.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol verwendet wird. Dieses Symbol ist in der Hauptressourcendatei ShowData.rc enthalten.
...
ShowDataDlg.h, ShowDataDlg.cpp - das Dialogfeld
    Diese Dateien enthalten Ihre CShowDataDlg-Klasse. Diese Klasse definiert das Verhalten des Hauptdialogfelds der Anwendung. Die Vorlage für das Dialogfeld befindet sich in ShowData.rc und kann in Microsoft Visual C++ bearbeitet werden.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen ShowData.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
