...
double jw56fr1_GetAccConversion(int index)
{
	//based on datesheet values
	switch (index)
	{
	case 0: return JW56FR1_CONVERSION_ACC_2G;
	case 1: return JW56FR1_CONVERSION_ACC_16G;
	case 2: return JW56FR1_CONVERSION_ACC_4G;
	case 3: return JW56FR1_CONVERSION_ACC_8G;
	default: return 0.0;
	}
}

double jw56fr1_GetGyroConversion(int index)
{
	//based on datesheet values
	switch (index)
	{
	case 0: return JW56FR1_CONVERSION_GYRO_245;
	case 1: return JW56FR1_CONVERSION_GYRO_125;
	case 2: return JW56FR1_CONVERSION_GYRO_500;
	case 4: return JW56FR1_CONVERSION_GYRO_1000;
	case 6: return JW56FR1_CONVERSION_GYRO_2000;
	default: return 0.0;
	}
}
