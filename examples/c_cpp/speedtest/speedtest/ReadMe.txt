================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: speedtest-Projektübersicht
===============================================================================

Diese speedtest-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt. Diese Anwendung zeigt nicht nur die Grundlagen der Verwendung von Microsoft Foundation Classes, sondern dient auch als Ausgangspunkt für das Schreiben Ihrer Anwendung.
...
speedtest.h
    ...
    Sie enthält andere projektspezifische Header (einschließlich Resource.h) und deklariert die CspeedtestApp-Anwendungsklasse.

speedtest.cpp
    Dies ist die wichtigste Anwendungsquelldatei, die die Anwendungsklasse CspeedtestApp enthält.
...
res\speedtest.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol verwendet wird. Dieses Symbol ist in der Hauptressourcendatei speedtest.rc enthalten.
...
speedtestDlg.h, speedtestDlg.cpp - das Dialogfeld
    Diese Dateien enthalten Ihre CspeedtestDlg-Klasse. Diese Klasse definiert das Verhalten des Hauptdialogfelds der Anwendung. Die Vorlage für das Dialogfeld befindet sich in speedtest.rc und kann in Microsoft Visual C++ bearbeitet werden.
